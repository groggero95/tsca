...
if __name__ == '__main__':
	...
	parser = argparse.ArgumentParser(description='Test comparison operations of the bigint library.')

	parser.add_argument("operation", help="Operation under test", type=str, choices=['eq', 'df', 'ge', 'gt', 'le', 'lt' ])
	...
	comp_test(args.operation, args.ntest, args.bits, args.varsize)
