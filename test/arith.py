...
if __name__ == '__main__':
	...
	parser = argparse.ArgumentParser(description='Test arithmetic operations of the bigint library.')

	parser.add_argument("operation", help="Operation under test", type=str, choices=['sum', 'sub', 'mul'])
